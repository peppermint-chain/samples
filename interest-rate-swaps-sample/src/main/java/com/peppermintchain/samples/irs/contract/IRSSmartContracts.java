...
public class IRSSmartContracts {
    private static final Logger logger = LoggerFactory.getLogger(IRSSmartContracts.class);
	...
	try {
	    ...
	    System.out.println("------> IRSChainCode[" + userId + "] Time taken = [" + (time2 - stime) + ":"
		    + (time3 - time2) + ":" + (time4 - time3) + ":" + (etime - stime) + " ms");
	}
    }

    @PMCEndPoint("checkForPayments")
    public void checkForPayments(PMCContractContext ctx, Map<String, String> params) throws Exception {
	...
	proposal.setCouponFrequency(params.get("couponFrequency"));
    ...
    private IRSContractProposal findProposal(PMCContractContext ctx, String contractId, String buyerId, String sellerId,
    ...
    private IRSContract findContract(PMCContractContext ctx, String contractId, String buyerId, String sellerId)
	    throws SQLException {
    ...
    private BigDecimal findInterestRate(PMCContractContext ctx, String indexName, String period, Date validForDate)
	    throws SQLException {
