...
var BackendService = (function () {
    ...
    BackendService.prototype.addNewOffer = function (o) {
        ...
        var tmpObject = o;
        tmpObject.maturityDate = o.maturityDate.toJSON();
        tmpObject.startDate = o.startDate.toJSON();
        return this.http
...
var OpenOffersComponent = (function () {
    ...
    OpenOffersComponent.prototype.ngOnInit = function () {
        var _this = this;
        var a = "2019-02-28T00:00:00.000Z";
        var b = "2019-02-28T00:00:00.000-0500";
        var d = (new Date(a));
        var abc = d.toJSON();
        //alert(a+" = "+(new Date(a)));
        //alert(b+" = "+(new Date(b)));
    ...
    OpenOffersComponent.prototype.acceptOffer = function (offer) {
        ...
        abc.startDate = toDateString(abc.startDate);
        abc.maturityDate = toDateString(abc.maturityDate);
        this.backendService.addNewOffer(offer).then(function (o2) {
            _this.backendService.fireEvent('refreshAll');
        });
    };
